...
srun $gmxexe mdrun -s $prefix.tpr -multidir $dirlist -ntomp $nrep -hrex -replex 2500 -reseed $RANDOM -nsteps $steps -deffnm ${label}_rep${replicate}.run.${final_steps} $continuestring $plumedstring $extraoptions
